			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{route('product')}}"><i class="icon-edit"></i><span class="hidden-tablet">Product</span></a></li>
						<li><a href="{{route('category')}}"><i class="icon-edit"></i><span class="hidden-tablet">Category</span></a></li>
						<li><a href="{{route('manufacture')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Manufacture</span></a></li>
						<li><a href="{{url('/add_blog')}}"><i class="icon-edit"></i><span class="hidden-tablet">Blog</span></a></li>
