			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
                           <a href="{{route('category')}}" class="btn btn-small btn-warning float-right">Update CATEGORY</a>
...
@endif
  ...
  <div class="form-group">
    <input type="text" class="form-control" placeholder="CATEGORY" name="category_name" value="{{$category->category_name}}">
  </div>
