					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								@endphp
								@if($customer != NULL || $customer_id != NULL)
								<li><a href="{{url('/checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								@if($shipping != NULL)
								<li><a href="{{url('/payment')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								@endif
                                @else
								<li><a href="{{url('/log_sign')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                @endif



								<li><a href="{{url('/show_cart')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                                @if($customer != NULL || $customer_id != NULL)
								<li><a href="{{url('/customer_logout')}}"><i class="fa fa-lock"></i> Logout</a></li>
                                @else
								<li><a href="{{url('/log_sign')}}"><i class="fa fa-lock"></i> Login</a></li>
                                @endif
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                @else
								<li><a href="{{url('/log_sign')}}"> Checkout</a></li>
                                @endif
