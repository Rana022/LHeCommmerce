							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<h2>{{$row->product_prize}}</h2>
											<p>{{$row->product_name}}</p>
											<a href="{{url('/product_details/'. $row->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
										</div>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="{{url('/product_details/'. $row->id)}}"><i class="fa fa-plus-square"></i>View Details</a></li>
									</ul>
								</div>
							</div>
						</div>
